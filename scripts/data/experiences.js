const experiences = [
  ...
  },
  {
    ...
    details: [
      ...
      "Design database schemas and RESTful APIs",
      "Building an backend side of platform where hotel guests can order laundry from their room using. Connecting hotel housekeeper, laundry, and hotel guests into 1 platform.",
      "Doing DDD approach involving strategic DDD (domain, subdomain, bounded contexts) and some tactical DDD (aggregate root, value object).",
      "Documented API using Swagger and ApiDog",
      "Collaborate with frontend developers, and UI/UX developers",
      "Leveraging Dokploy for CI/CD, staging, and production deployments",
    ],
    skills: [
      "Spring Boot",
      "Spring Security",
